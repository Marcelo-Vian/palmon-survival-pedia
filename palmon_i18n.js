(function () {
  ...
  const phrases = [
    ...
    ['Palmon Survival - Shop Capture Analyzer', 'Palmon Survival - Shop Capture Analyzer'],
    ['Palmon Survival Shop Flow', 'Palmon Survival Shop Flow'],
    ['Análise da loja por prints do Android Helper', 'Shop analysis from Android Helper screenshots'],
    ['Tabela de pacotes, itens e preços extraída dos prints', 'Table of packages, items, and prices extracted from screenshots'],
    ['Tabela extraída dos prints do Android Helper com pacotes, itens, preços, filtros por recurso e custo-benefício por real.', 'Table extracted from Android Helper screenshots with packages, items, prices, resource filters, and value per real.'],
    ['Sem publicar prints no site:', 'Without publishing screenshots on the site:'],
    ['esta página usa os prints só como fonte de leitura e transforma as ofertas ativas em tabela filtrável.', 'this page uses the screenshots only as a reading source and turns active offers into a filterable table.'],
    ['Itens com ícone sem texto oficial ficam com nome funcional e confiança marcada.', 'Items whose icon has no official text get a functional name and marked confidence.'],
    ['Melhores decisões rápidas', 'Best quick decisions'],
    ['Tabela extraida por leitura visual dos prints.', 'Table extracted by visual reading of the screenshots.'],
    ['Quando o overlay cobriu parte da oferta, a linha fica marcada como parcial.', 'When the overlay covered part of the offer, the row is marked as partial.'],
    ['Ofertas extraídas', 'Extracted offers'],
    ['linhas deduplicadas', 'deduplicated rows'],
    ['Ativas', 'Active'],
    ['com preço/compra visível', 'with visible price/purchase'],
    ['Com preço', 'With price'],
    ['R$ extraído do print', 'BRL extracted from screenshot'],
    ['Menor ticket', 'Lowest ticket'],
    ['pacote mais barato', 'cheapest package'],
    ['Melhor Pallite/R$', 'Best Pallite/BRL'],
    ['Melhor acelerador/R$', 'Best speedup/BRL'],
    ['Melhor Skillfruit/R$', 'Best Skillfruit/BRL'],
    ['Menor gasto útil', 'Lowest useful spend'],
    ['Buscar pacote, item, seção ou cap', 'Search package, item, section, or cap'],
    ['Todas categorias', 'All categories'],
    ['Todos status', 'All statuses'],
    ['Pendente/amanhã', 'Pending/tomorrow'],
    ['Comprado/indisponível', 'Bought/unavailable'],
    ['Ordenar por recurso', 'Sort by resource'],
    ['Toda confiança', 'All confidence'],
    ['Alta', 'High'],
    ['Média', 'Medium'],
    ['Baixa/parcial', 'Low/partial'],
    ['Pacote', 'Package'],
    ['Preço', 'Price'],
    ['Itens', 'Items'],
    ['Score do filtro', 'Filter score'],
    ['Decisão', 'Decision'],
    ['Esta página lê o padrão', 'This page reads the pattern'],
    ['organiza o fluxo capturado e mostra onde há preço, rows, abas, sold out provável e overlay visível.', 'organizes the captured flow and shows where there are prices, rows, tabs, likely sold out, and visible overlay.'],
    ['Os valores em R$ e itens ainda são conferidos visualmente no print.', 'BRL values and items are still verified visually in the screenshot.'],
    ['Voltar ao hub', 'Back to hub'],
    ['Resumo por loja', 'Summary by shop'],
    ['Fluxo recomendado', 'Recommended flow'],
    ['Capturas', 'Captures'],
    ['prints lidos', 'screenshots read'],
    ['Preços', 'Prices'],
    ['botões detectados', 'buttons detected'],
    ['linhas detectadas', 'detected rows'],
    ['Overlay', 'Overlay'],
    ['visível', 'visible'],
    ['Sold out', 'Sold out'],
    ['provável', 'likely'],
    ...
    ['fluxos', 'flows'],
    ['1. Filtre por item/preço', '1. Filter by item/price'],
    ['Use loja, tipo e quantidade de preços para achar telas úteis.', 'Use shop, type, and price-button count to find useful screens.'],
    ['2. Abra o print', '2. Open the screenshot'],
    ['Clique no card para ver o print grande e confirmar preço/itens.', 'Click the card to view the large screenshot and confirm price/items.'],
    ['3. Marque valor real', '3. Mark the real value'],
    ['Quando quisermos, adiciono campos manuais de preço e item para cálculo automático.', 'When we want, I can add manual item and price fields for automatic calculation.'],
    ['4. Próximas capturas', '4. Next captures'],
    ['Se o alerta de overlay aparecer, mova o overlay para não cobrir título/abas.', 'If the overlay warning appears, move the overlay so it does not cover title/tabs.'],
    ['Buscar por arquivo, tipo, loja ou cap', 'Search by file, type, shop, or cap'],
    ['Todas lojas', 'All shops'],
    ['Todos tipos', 'All types'],
    ['Qualquer preço', 'Any price'],
    ['Com preço', 'With price'],
    ['Sem preço', 'No price'],
    ['Overlay: todos', 'Overlay: all'],
    ['Com overlay', 'With overlay'],
    ['Sem overlay', 'No overlay'],
    ['Sold out: todos', 'Sold out: all'],
    ['Provável sold out', 'Likely sold out'],
    ['Sem sold out provável', 'No likely sold out'],
    ['Tabela de auditoria', 'Audit table'],
    ['Arquivo', 'File'],
    ['Passe/privilegio', 'Pass/privilege'],
    ['Lista de bundles', 'Bundle list'],
    ['Oferta popup', 'Offer popup'],
    ['Oferta unica', 'Single offer'],
    ['overlay visível', 'visible overlay'],
    ['sem overlay', 'no overlay'],
    ['sem sold out', 'no sold out'],
    ['preços', 'prices'],
    ['Overlay cobre topo/esquerda; pode esconder titulo, abas ou nome do pacote.', 'Overlay covers top/left; it may hide title, tabs, or package name.'],
    ['Overlay cobre meio/esquerda; pode esconder nome do pacote, itens ou parte da primeira oferta.', 'Overlay covers middle/left; it may hide package name, items, or part of the first offer.'],
    ['Overlay possivel no topo; conferir se nome/aba ficou legivel.', 'Possible overlay near the top; check whether name/tab stayed readable.'],
    ['Precisa leitura visual/OCR', 'Needs visual/OCR review'],
    ['Sem preco detectado pelo helper', 'No price detected by the helper'],
    ['Pacotes', 'Packages'],
    ['Ofertas', 'Offers'],
    ['resultados', 'results'],
  ...
  phrases.push(
    ['Classes S2', 'S2 Classes'],
    ['Classes e Skill Points: Season 2', 'Classes and Skill Points: Season 2'],
    ['Sistema confirmado no APK/XAPK e nos seus prints.', 'System confirmed in the APK/XAPK and in your screenshots.'],
    ['Existem duas classes, Builder e Fighter.', 'There are two classes, Builder and Fighter.'],
    ['O total de pontos não é separado por classe', 'The point total is not separated by class'],
    ['ao trocar classe, o jogo reseta as skills e reembolsa os pontos gastos', 'when switching class, the game resets skills and refunds spent points'],
    ['Como ler a tela', 'How to read the screen'],
    ['Como ganhar Explorer XP', 'How to earn Explorer XP'],
    ['Qual classe escolher', 'Which class to choose'],
    ['Distribuição recomendada com 55 pontos', 'Recommended distribution with 55 points'],
    ['Classe / objetivo', 'Class / goal'],
    ['Distribuição prática', 'Practical distribution'],
    ['Por que', 'Why'],
    ['Próxima mudança', 'Next change'],
    ['Fighter: skills, efeito e prioridade', 'Fighter: skills, effect, and priority'],
    ['Builder: skills, efeito e prioridade', 'Builder: skills, effect, and priority'],
    ['Desbloqueio', 'Unlock'],
    ['Efeito no nível máximo', 'Effect at max level'],
    ['Prioridade', 'Priority'],
    ['pontos livres', 'free points'],
    ['pontos totais', 'total points'],
    ['zero pontos livres', 'zero free points'],
    ['derrotar Wild Palmon', 'defeat Wild Palmon'],
    ['capturar Sanctums e Sacred Springs', 'capture Sanctums and Sacred Springs'],
    ['upar construções exclusivas da season', 'upgrade season-exclusive buildings'],
    ['melhor para crescimento, economia, construção, pesquisa, coleta e suporte de guilda', 'best for growth, economy, construction, research, gathering, and guild support'],
    ['melhor para PvP, rallies, Sanctum, defesa/ataque de camp e buffs de Palmon', 'best for PvP, rallies, Sanctum, camp attack/defense, and Palmon buffs'],
    ['Evite trocar sem motivo', 'Avoid switching without a reason'],
    ['seu caso atual', 'your current case'],
    ['Pacote de XP', 'XP package'],
    ['pacote de XP', 'XP package'],
    ['pacote de combate', 'combat package'],
    ['guerra de mapa', 'map war'],
    ['crescimento e F2P', 'growth and F2P'],
    ['guilda ativa', 'active guild'],
    ['Muito alta', 'Very high'],
    ['Alta', 'High'],
    ['Média', 'Medium'],
    ['Média-alta', 'Medium-high'],
    ['Top S2', 'Top S2'],
    ['Top ao liberar', 'Top when unlocked'],
    ['Obrigatória para Fighter', 'Mandatory for Fighter'],
    ['pré-requisito de Hyper Frenzy', 'Hyper Frenzy prerequisite'],
    ['redução de dano dos Palmons', 'Palmon damage reduction'],
    ['dano enquanto estiver em Frenzy', 'damage while in Frenzy'],
    ['ao iniciar ou entrar em rally', 'when starting or joining a rally'],
    ['defendendo camp', 'defending camp'],
    ['atacando camp inimigo', 'attacking an enemy camp'],
    ['construção', 'construction'],
    ['pesquisa', 'research'],
    ['coleta', 'gathering'],
    ['velocidade de construção', 'construction speed'],
    ['velocidade de pesquisa', 'research speed'],
    ['custo de construção', 'construction cost'],
    ['custo de pesquisa', 'research cost'],
    ['A Pedia usa o número exibido no jogo', 'The Pedia uses the number shown in-game'],
    ['Fórmula exata', 'Exact formula'],
    ['não confirmada', 'not confirmed'],
    ['Recomendação direta para seu caso:', 'Direct recommendation for your case:'],
    ['não resete só por curiosidade', 'do not reset just out of curiosity'],
    ['ao chegar Lv50', 'when you reach Lv50'],
    ['antes de investir em coisa econômica', 'before investing in economic skills'],
    ['Achievements', 'Achievements'],
    ['Achievements: onde investir Omni-Tokens', 'Achievements: where to invest Omni-Tokens'],
    ['Distribuidor automático de pontos', 'Automatic point allocator'],
    ['Use esta ferramenta em vez de seguir uma tabela fixa.', 'Use this tool instead of following a fixed table.'],
    ['Classe', 'Class'],
    ['Objetivo', 'Goal'],
    ['Explorer Level', 'Explorer Level'],
    ['Pontos totais', 'Total points'],
    ['Equilibrado: XP + função principal', 'Balanced: XP + main role'],
    ['Combate/PvP/rally', 'Combat/PvP/rally'],
    ['Crescimento/F2P/base', 'Growth/F2P/base'],
    ['Mapa S2: Holy Tower/Curse', 'S2 map: Holy Tower/Curse'],
    ['Ordem', 'Order'],
    ['Skill', 'Skill'],
    ['Pontos', 'Points'],
    ['Grupo', 'Group'],
    ['Por que entrou', 'Why it was picked'],
    ['Calculando', 'Calculating'],
    ['Próxima ação', 'Next action'],
    ['próxima prioridade', 'next priority'],
    ['Onde investir', 'Where to invest'],
    ['Palmon | Achievements', 'Palmon | Achievements'],
    ['bônus globais', 'global bonuses'],
    ['Faça primeiro', 'Do first'],
    ['Regra das fichas', 'Token rule'],
    ['fichas UR excedentes', 'excess UR tokens'],
    ['Ficha UR específica excedente', 'Excess specific UR token'],
    ['Omni-Token/Refund', 'Omni-Token/Refund'],
    ['Elemental Guardian', 'Elemental Guardian'],
    ['Prioridade prática de investimento', 'Practical investment priority'],
    ['Custos e bloqueios importantes', 'Important costs and locks'],
    ['Tipo de custo', 'Cost type'],
    ['Bloqueio / observação', 'Lock / note'],
    ['Resposta curta para decisão:', 'Short decision answer:'],
    ['gaste em Critical Hit', 'spend on Critical Hit'],
    ['depois It’s Over 9000!', 'then It’s Over 9000!'],
    ['depois no achievement do elemento do seu time principal', 'then on your main team element achievement'],
    ['ficha específica usada em achievement não volta no reset', 'specific tokens used in achievements are not returned on reset'],
    ['A página monta a distribuição recomendada e mostra o próximo investimento.', 'The page builds the recommended allocation and shows the next investment.'],
    ['O primeiro número é ponto livre; o segundo é o total que a ferramenta precisa.', 'The first number is free points; the second is the total the tool needs.']
  );
